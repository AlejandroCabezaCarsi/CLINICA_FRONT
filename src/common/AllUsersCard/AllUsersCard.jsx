    ...
    return(
        ...
        <Container fluid className="d-flex flex-row justify-content-around">
            <Row className=" AllUsersCardDesign d-flex justify-content-around mt-3">
                <Col xs={7} lg={8} className="d-flex flex-column justify-content-around align-items-center">
                    ...
                    <Row className="d-flex flex-column text-center">
                        <Col><div className="emailA fontWeight">Email</div></Col>
                        <Col><div className="emailAContent">{email}</div></Col>
                    </Row>
                    <Row className="d-flex flex-column text-center">
                        <Col><div className="roleA fontWeight">Role</div></Col>
                        <Col>{role}</Col>
                    </Row>
                </Col>
                ...
                <Col className="d-flex flex-column justify-content-around align-items-center">
                    <Row className="d-flex flex-column text-center">
                        <Col> <div className="lastnameA fontWeight">Lastname</div></Col>
                        <Col>{lastname}</Col>
                    </Row>
                    <Row className="d-flex flex-column text-center">
                        <Col><div className="phoneNumberA fontWeight">Telefono </div></Col>
                        <Col>{phoneNumber}</Col>
                    </Row>
