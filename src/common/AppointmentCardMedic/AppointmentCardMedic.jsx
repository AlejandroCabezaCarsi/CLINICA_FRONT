...
export const AppointmentCardMedic = ({
  id,
  fecha,
  user,
  clinica,
    ...
    <Container fluid>
      <Row className="appointmentCardMedicDesign m-3">
        ...
        <Col sm={5} md={2} lg={3} className="tratamientoM centerCenter ">
          <div className="tratamientoTituloM centerCenter fontWeight">
            TRATAMIENTO
          </div>
        ...
        <Col
          sm={12}
          className="botonesOpcionCitaM d-flex flex-row justify-content-around align-items-center mt- mb-2"
        >
          <div
            className="editaCita"
